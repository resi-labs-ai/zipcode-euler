...
// Pin to the in-tree SDK snapshot (DEP SEAM: every cre/* module replaces the in-tree SDK snapshot). The
// published releases predate the WriteCreReportRequest split and testutils.SetTimeProvider this module +
// its tests use.
