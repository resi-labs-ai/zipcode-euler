...
// This slice is engine-epoch driven (§8.6 cron heartbeat). The scheduler/cron capability replaces the
// in-tree snapshot via the same relative-replace idiom.
