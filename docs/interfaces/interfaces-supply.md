...
A read-only view of `SzipNavOracle`. The DurationFreezeModule reads it to enforce the freeze floor — keeping the juniorTrancheSidecar's covered value above its utilization-based minimum. It exposes:
