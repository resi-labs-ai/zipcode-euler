...
> **RE-AUTHORED 2026-06-07 to the two-token / Exit-Gate model (`baal-spec.md` §2/§3/§4/§5). Build from THIS ticket.**
...
**Spec §**
`baal-spec.md` §4 (the generalized issuance core — `Gate.depositFor(asset, amount, receiver) → shares`, NAV-
