# 8-B1 — szipUSD Baal substrate scaffold (summon script) (§4.5 / `baal-spec.md` 8-B1)
...
`baal-spec.md` 8-B1 (the authoritative build recipe + the Authority model block, both rewritten 2026-06-07). Cross:
...
the §4.5 item-0 / `baal-spec.md` resolution of the old (un-reachable) "post-deploy `setShamans`" seam — user-ratified
