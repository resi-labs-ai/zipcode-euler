...
- **`claude-zipcode.md §4.5.1` 8-B8 "State" line** — the only spec touch, cosmetic: "pending-exercise accounting; the
  ...
  the 8-B11 robot." No §17 reopened. (`baal-spec.md §10.8` 8-B8 already described the module faithfully — untouched.)
...
- **NEXT = 8-B9** (sell module — HYDX→USDC via `SwapRouter.exactInputSingle` market-sell to repay the 8-B5 borrow
  immediately + the zipUSD→xALPHA POL buy leg; soft-bleed caps = the loop size gate; `baal-spec.md §10.8` 8-B9,
