...
- `reports/baal-spec.md §10.8` — the 8-B7 "Where it lives" + "Source + addresses" lines corrected to match (the staging
...
- **NEXT = 8-B8** (exercise/strike-financing module — LP → reservoir collateral → CRE-borrow USDC → exercise oHYDX →
  HYDX; depends 8-B5 + 8-B7; `reports/baal-spec.md §10.8` / §4.5.1 8-B8 block).
