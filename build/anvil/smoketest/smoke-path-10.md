...
quiescent-state `setTokens` guard (SUPPLY-ADV-16, negative). Sources: `docs/supply/szipUSD/OffRampModule.md`,
...
are outstanding → reverts (SUPPLY-ADV-16 quiescent-state guard).
...
**Result.** **PASS** (2026-06-24, live fork; scaleUp 1e12, EPOCH_DURATION 30 days).
...
- `InsufficientClaimable` (0xeb6def51) on re-claim proven 2026-06-10. **No flaws** — senior par exit + queue-only burn hold.
